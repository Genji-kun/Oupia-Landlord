            ...
            <>
                <span
                    className="text-nowrap absolute top-1/2 -translate-y-1/2 font-semibold
                        left-full rounded px-3 py-1.5 ml-8 bg-border dark:bg-slate-800 text-primary-500 border border-border
