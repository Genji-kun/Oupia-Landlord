    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2 justify-between">
                <h1 className="font-semibold uppercase">Chứng nhận thuê trọ</h1>
                <div className="flex items-center gap-2">
                    ...
                    <Link to="/certifications/create">
                        <Button className="w-fit h-fit bg-primary-500 hover:bg-primary-500/90 px-4">Thêm chứng nhận</Button>
                    </Link>
                </div>
